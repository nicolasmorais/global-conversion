...
const checkoutTranslations = {
  en: {
    ...
    fastShippingDesc: "Your product is shipped directly to your address, with tracking via email.",
  ...
  es: {
    ...
    fastShippingDesc: "Tu producto se envía directamente a tu dirección, con rastreo por email.",
  ...
  pt: {
    ...
    fastShippingDesc: "Seu produto é enviado diretamente ao seu endereço, com rastreamento por email.",
  ...
  fr: {
    ...
    fastShippingDesc: "Votre produit est expédié directement à votre adresse, avec suivi par email.",
  ...
  de: {
    ...
    fastShippingDesc: "Ihr Produkt wird direkt an Ihre Adresse geliefert, mit Tracking per E-Mail.",
  ...
  it: {
    ...
    fastShippingDesc: "Il tuo prodotto viene spedito direttamente al tuo indirizzo, con tracciamento via email.",
